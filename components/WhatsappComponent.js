...
const WhatsappComponent = () => {
  return (
    <div className="w-full mt-4">
      <div className="max-w-6xl border border-[#eafafe] mx-auto bg-[#ecf4fd] rounded-2xl flex flex-col justify-center items-center p-8">
        ...
        <p className="text-center text-xs md:text-sm lg:text-[16px] text-black pb-6">
