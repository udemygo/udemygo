  ...
  const features = [
    {
      ...
      description: "We share verified university details to keep you safe from scams.",
  ...
  return (
    <div className="bg-blue-900 text-white py-12 px-4 sm:px-8 ">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-4">Online MBA Admission Procedure</h2>
        
        <p className="mb-8">
          Learn the online MBA course admission process for enrolling in the online MBA course at any university, get through the down steps;
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 ">
          {features.map((feature, index) => (
            <div key={index} className="bg-blue-800 p-6 rounded-lg flex flex-col items-center">
              <div className="mb-4">
                {feature.icon}
              </div>
