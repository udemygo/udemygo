  ...
  return (
    <div className="max-w-6xl mx-auto pb-8">
      ...
      <p className="mb-6 text-sm text-gray-700">
        ...
        <span className=" font-medium">online MBA course curriculum</span>{" "}
        before going to learn the course, there is a general syllabus of this
        program that states what covers the program and what kind of skills you
        obtained{" "}
        <span className=" font-medium">while learning the program</span>.
      </p>
